...
"""
Code is from https://github.com/tensorboy/pytorch_Realtime_Multi-Person_Pose_Estimation
"""
...
def get_model(trunk='vgg19'):
    ...
    :param str trunk: 'vgg19' or 'mobilenet'
    :return: Module, the defined model as an object class of rtpose_model (want to fix this naming...)
    """
    blocks = {}
    # block0 is the preprocessing stage, this would be the features
    if trunk == 'vgg19':
        block0 = [{'conv1_1': [3, 64, 3, 1, 1]},  # (in_channels, out_channels, kernel_size, stride=1, padding=0)
                  {'conv1_2': [64, 64, 3, 1, 1]},
                  {'pool1_stage1': [2, 2, 0]},
    ...
    # this is the actual model they develop
    class rtpose_model(nn.Module):
        """
        They create the model dictionary above than add it to this class
        """
    ...
    # Initialize an object of the class and return it
...
def get_multipose_model(model_path, cuda=True):
