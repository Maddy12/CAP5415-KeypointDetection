...
ROOT_DIR = 'C:/Users/brand/OneDrive/UCF/Fall_2018/Computer_Vision/Project/CAP5415-KeypointDetection/evaluate'
DATA_HOME_DIR = 'D:/INRIAPerson'

# paths
data_path = DATA_HOME_DIR + '/' 
split_train_path = data_path + '/96X160H96/Train/'
#full_train_path = data_path + '/train_full/'
valid_path = data_path + '/96X160H96/Valid/'
test_path = DATA_HOME_DIR + '/70X134H96/Test/'
...
def test(test_loader, model):
    ...
    for aug in range(nb_aug):
        ...
        for i, (images, filepath) in enumerate(test_loader):
            ...
            image_var = torch.autograd.Variable(images, volatile=True)
            if image_var.shape[2] != 3:
                image_var = image_var[:,0:3,:,:]
            y_pred = model(image_var)
