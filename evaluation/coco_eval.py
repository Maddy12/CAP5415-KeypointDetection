...
import torch
import sys
main_dir = r'C:\Users\maddy\OneDrive - Knights - University of Central Florida\CAP5415-KeypointDetection\version1\pytorch_Realtime_Multi-Person_Pose_Estimation'
sys.path.append(main_dir + r'\training\datasets\coco_data')
from preprocessing import (inception_preprocess, rtpose_preprocess, ssd_preprocess, vgg_preprocess)
